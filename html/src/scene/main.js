...
const modelurl5 = "./models/shield (3).glb";
...
window.step8 = ()=>{
    ...
    new TWEEN.Tween(orbit1.scale).to({ x: 1, y: 1, z: 1}, 1000).start();
    new TWEEN.Tween(orbit2.scale).to({ x: 1, y: 1, z: 1}, 1000).start();
    new TWEEN.Tween(orbit3.scale).to({ x: 1, y: 1, z: 1}, 1000).start();
...
window.step9 = ()=>{
  ...
  let cameraFrom = {
    ...
    new TWEEN.Tween(orbit1.scale).to({ x: 10, y: 10, z: 10}, 1000).start();
    new TWEEN.Tween(orbit2.scale).to({ x: 10, y: 10, z: 10}, 1000).start();
    new TWEEN.Tween(orbit3.scale).to({ x: 10, y: 10, z: 10}, 1000) .start();
...
window.step1Mobile = ()=>{
  ...
  new TWEEN.Tween(cameraFrom).to({ x: 0, y: 15, z: 40}, 2000)
  .easing(TWEEN.Easing.Cubic.Out)        
  .onUpdate(function () {
      camera.position.set(cameraFrom.x, cameraFrom.y, cameraFrom.z);
  }).start();
  ...
  window.step3Mobile = ()=>{
      ...
      new TWEEN.Tween(cameraFrom).to({ x: 0, y: 0, z: 29}, 2000)
      .easing(TWEEN.Easing.Cubic.Out)
      .onComplete(function(){
  ...
  window.step4Mobile = ()=>{
      ...
      new TWEEN.Tween(cameraFrom).to({ x: 0, y: 0, z: 39}, 2000)
      .easing(TWEEN.Easing.Cubic.Out)
      .onComplete(function(){
  ...
  window.step5Mobile = ()=>{
      ...
      new TWEEN.Tween(cameraFrom).to({ x: 0, y: 0, z: 47}, 2000)
      .easing(TWEEN.Easing.Cubic.Out)
      .onComplete(function(){
          shield2.rotation.y = 0;
      })       
  ...
  window.step6Mobile = ()=>{
      ...
      new TWEEN.Tween(cameraFrom).to({ x: 0, y: 20, z: 40}, 2000)
      .easing(TWEEN.Easing.Cubic.Out)        
      .onUpdate(function () {
          camera.position.set(cameraFrom.x, cameraFrom.y, cameraFrom.z);
      }).start();
